...
Follow these steps meticulously:
  a. Parse Input: Carefully read and understand the user's project description provided: "{TaskSendParams.message.parts[0].text}"
...
Input:
{TaskSendParams.message.parts[0].text}
