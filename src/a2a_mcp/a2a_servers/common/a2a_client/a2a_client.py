# A2A Client: Any application or agent that consumes A2A services.
# It initiates interactions by sending requests (such as tasks/send or tasks/sendSubscribe) to an A2A Server's endpoint.
